...

{
    ...
    TASK_NAME='PTPCG_P1-legal-woTgg-wOtherType-20epoch-5-26'
    RUN_MODE='legal_wo_tgg'
    TEMPLATE='legal_wo_tgg'
    INFERENCE_DUMPPATH='legal-woTgg-wOtherType-100epoch-5-26-predict.json'
